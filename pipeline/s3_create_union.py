...
import utils.read_write_file 
import utils.association_with_regions
...
def main():               
    ...
    for width in [150]:
        ...
        write_regions_bed3(regions,'CTCF_union_summits_fe4_width_{}.bed'.format(width))
